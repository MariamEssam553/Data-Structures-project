...
public:
	...
	void PrintWTorders(string msg) const;//prints waiting orders of each type; its purpose to write a new line other than print message
	void Printcooks(string msg) const;//prints cooks of each type
	void PrintAssigning(string msg) const;//in last timestep, print assignment of order to cook
	void PrintFTorders(string msg) const;//prints orders that are served or in finished stage
	void PrintMessage(string ,string,string) const;
