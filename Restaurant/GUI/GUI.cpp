...
//	ClearStatusBar();	//First clear the status bar
	...
	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD, BY_NAME, "Arial");
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 4), msg); // You may need to change these coordinates later 
																		  // to be able to write multi-line
}
void GUI::PrintWTorders(string msg) const
{

	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD, BY_NAME, "Arial");
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.3), msg); // You may need to change these coordinates later 
																		  // to be able to write multi-line
}

void GUI::Printcooks(string msg) const
{

	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD, BY_NAME, "Arial");
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.6), msg); // You may need to change these coordinates later 
																		  // to be able to write multi-line
}

void GUI::PrintAssigning(string msg) const
{

	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD, BY_NAME, "Arial");
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.7), msg); // You may need to change these coordinates later 
																		  // to be able to write multi-line
}

void GUI::PrintFTorders(string msg) const
{

	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD, BY_NAME, "Arial");
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 2.1), msg); // You may need to change these coordinates later 
																		  // to be able to write multi-line
}

void GUI::PrintMessage(string m1,string m2, string m3) const
{
		ClearStatusBar();	//First clear the status bar
	...
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.1), m1);
	pWind->DrawString(10, WindHeight +10 - (int)(StatusBarHeight / 1.1), m2);
	pWind->DrawString(10, WindHeight + 30 - (int)(StatusBarHeight / 1.1), m3);
}
